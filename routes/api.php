...
Route::middleware('auth:api')->group(function (){
    ...
    Route::get('/users/recent',[App\Http\Controllers\UserController::class,'getRecentActivities']);
    Route::get('/users/logs',[App\Http\Controllers\UserController::class,'getUserLogs']);
});
